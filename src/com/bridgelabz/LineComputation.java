...
public class LineComputation {
    ...
    public static void DistanceBetweenPoint(){
       ...
       //uc3 comparison between two lines
    public  void comparisonBetweenLines() {
        System.out.println("The Coordinates of 1st line are:");
        System.out.print("X1 = ");
        X1 = sc.nextInt();
        System.out.print("Y1 = ");
    ...
    //uc4 all three calculation in one class
    ...
    public static void main(String[] args){
        ...
        object.comparisonBetweenLines();
        object.EvaluateLines();
    }
}
